...
function addProduct(){
	...
	if(count($errors) == 0){
		...
		$query="INSERT into products (product_name, product_category, product_supplier, product_quantity, product_discount, product_price, product_date) values ('$name', '$category','$supplier', '$quantity', '$discount', '$price', '$date')";
		mysqli_query($conn, $query);
